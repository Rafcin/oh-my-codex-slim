...
Read [`docs/benchmarking.md`](../docs/benchmarking.md) before executing the suite. Planning, dry runs, fixture validation, and oracle validation consume no model quota. The 36-run comparison requires separate explicit approval.
